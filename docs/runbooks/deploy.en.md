# Runbook — sdkwork-github-workflow deploy / upgrade / rollback (EN)
...
targets. Image reference: `registry.sdkwork.com/apps/sdkwork-github-workflow-standalone:0.1.0`
...
install syncs the bundle to `/opt/deploy/sdkwork-github-workflow/bundle`, loads the image, starts
